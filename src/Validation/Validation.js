...
export const validationSchema = Yup.object().shape({
  ...
  arrivedAirport: Yup.string()
    ...
    .notOneOf(
      [Yup.ref("departureAirport"), null],
      "Arrival airport and Departure airportshould not be same"
    ),
  ...
  paymentDateTime: Yup.date()
    ...
    .min(new Date(), "Invalid payment date and time, it must be a future date"),
  Phone: Yup.string()
